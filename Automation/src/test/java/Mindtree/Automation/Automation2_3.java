...
public static void main(String[] args) {
	...
	//Signing up for nobroker platform with invalid data
	...
	driver.findElement(By.xpath("//*[@id=\"login-signup-form__password-input\"]")).sendKeys("ahme168");
